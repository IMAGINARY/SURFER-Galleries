...
\begin{surferGalIntroPage}
  \begin{galTitle}Die phantasievollen Flächen\end{galTitle}
  % 
  \begin{surferText}
...
In dieser Galerie können Sie nun die Schönheit der Mathematik selbst interaktiv erleben und gestalten. Tippen Sie auf eine der Fl\"achen rechts. Der mathematische Zusammenhang zwischen den Formen und den Formeln wird an Beispielen in einfachen Worten beschrieben. \\ Die Phantasie und die Intuition kommen von Ihnen...
      \end{surferText}
