\begin{surferPage}[D5+- Singularity]{$D_5^{+-}$ Singularity}
	...
	\begin{Centering*}%
		\includegraphics[width=1.2cm]{../../common/images/D5pm_03}\quad%
		\includegraphics[width=1.2cm]{../../common/images/D5pm_02}\quad%
		\includegraphics[width=1.2cm]{../../common/images/D5pm_01}%
	\end{Centering*}
	...
	\begin{Centering*}%
		\includegraphics[width=1.2cm]{../../common/images/D5pm_01}\quad%
		\includegraphics[width=1.2cm]{../../common/images/D5pm_04}\quad%
		\includegraphics[width=1.2cm]{../../common/images/D5pm_05}%
	\end{Centering*}
\end{surferPage}
