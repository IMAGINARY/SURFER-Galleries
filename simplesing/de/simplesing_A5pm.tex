\begin{surferPage}[A5+- Singularität]{Eine $A_5^{+-}$ Singularität}
...
%    \dontshow{
    ...
    \begin{center}
      ...
      \begin{tabular}{@{}c@{\quad}c@{\quad}c@{}}
        \begin{tabular}{@{}c@{}}
          \includegraphics[width=1.2cm]{../../common/images/A5pm_0}
        \end{tabular}
        &
        \begin{tabular}{@{}c@{}}
          \includegraphics[width=1.2cm]{../../common/images/A5pm_1}
        \end{tabular}
        &
        \begin{tabular}{@{}c@{}}
          \includegraphics[width=1.2cm]{../../common/images/A5pm_2}
        \end{tabular}
      \end{tabular}
    \end{center}
%    }
