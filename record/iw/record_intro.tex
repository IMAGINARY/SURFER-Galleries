\begin{surferIntroPage}{משטחים שקבעו שיאי עולם}{record_chmutovoktic}{משטחים שקבעו שיאי עולם}
    משטח מכונה \emph{לא-סינגולרי} או \emph{חלק} אם הוא אינו כולל שום קדקוד (קדקודים כאלה מכונים \emph{נקודות סינגולריות}). דוגמאות למשטחים חלקים הם ספֶרָה או טוֹרוּס, ראו שתי התמונות הראשונות
    משמאל להלן.  
