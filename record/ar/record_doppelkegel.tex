\begin{surferPage}[Double Cone]{المخروط المزدوج \textenglish{(Double Cone)}}
كما شرحنا في مقدمة هذه الجاليريا، نتكلم عن منحنىً \emph{أملس }حين لا يكون له نتوءات (والتي تٌسمى متفردات).
   هذه هي الحال مع كرة أو مع طارة (الصورتان أدناه في الطرف الشمالي):
    \begin{center}
      ...
      \end{tabular}
    \end{center}
     المخروط المزدوج (الصورة إلى اليمين) هو اسهل المنحنيات المتفردة: إنه المتفرد الوحيد الذي يمكن وصفه بواسطة معادلة من الدرجة الثانية:
    \[x^2+y^2-z^2=0.\]
