...
\begin{surferPage}
  \begin{surferTitle}The Endraﬂ Octic\end{surferTitle} \\
     In 1995, Stephan Endraﬂ constructed this surface of degree $8$ (octic) as the 
    ...
    The exact number is not known.
     ...
     Finding the surface was not easy: Endraﬂ had to search for it in a
