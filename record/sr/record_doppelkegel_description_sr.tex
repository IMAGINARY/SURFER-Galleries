...
\begin{surferPage}
  \begin{surferTitle}Двострука купа\end{surferTitle}  \\
   Као што је објашњено у уводу, површ се назива 
    ...
    \end{center}
    \vspace{-0.3cm}
     Двострука купа (слика десно) је најједнаставнији сингуларитет; то је једини сингуларитет који се
	 може описати једначином степена 2 $2$:
    \[x^2+y^2-z^2=0.\]
...
%    }
    \vspace{-0.2cm}
   Површ степена $2$ не може имати више од једног сингуларитета \  
    $\mu(2)=1$.
