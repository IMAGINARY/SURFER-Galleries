\begin{surferPage}[Cayley-Cubic]{משטח ממעלה שלישית של קיילי}
   זהו משטח ממעלה שלישית. הוא מופיע גם
    בגלריית המשטחים הפשוטים. 
    הוא כולל ארבע נקודות סינגולריות כפולות-חרוט.
    המשטח נקרא על שם ארתור קיילי (Arthur Cayley) שערך מספר גדול של מחקרים על משטחים מהמעלה השלישית
    במאה ה-$19$.
    
     ואולם, היה זה לוּדוויג שלַפלי (Ludwig Schl?₪fli) שבשנת 1863 סיווג לראשונה את המשטחים האלה
    ...
    בסביבות שנת 1900, חקר פליקס קליין (Felix Klein) את הצורות האפשריות של משטחים אמתיים מהמעלה השלישית; 
