\begin{surferIntroPage}{세계기록을 가지고 있는 곡면들}{record_chmutovoktic}{세계기록을 가지고 있는 곡면들}
    뾰족점이 없는 곡면은 \emph{비-특이} 혹은 \emph{매끄럽다} 라고 부릅니다.(이러한 점들을 \emph{특이점} 이라 합니다) 매끄러운 곡면의 예로는 구와 도넛이 있습니다. 
 \begin{center}
      \vspace{-0.2cm}
    ...
    \end{center}
    \vspace{-0.2cm}
    곡면이 특이점을 갖는다는 것은 매우 특별한 상황에 해당됩니다. SURFER 프로그램에서의 곡면들은 다항식으로부터 만들어집니다. 다항식의 가장 높은 차수 $d$를 이 다항식의 차수라고 합니다. 수학자들은 특정 차수를 갖는 다항식이 얼마나 많은 특이점을 갖는지에 대해 질문을 던져 왔습니다. 우리는 그 숫자를 $\mu(d)$ 라고 부릅니다.
