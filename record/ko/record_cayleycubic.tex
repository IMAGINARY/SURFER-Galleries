...
1900년즈음 펠릭스 클라인이라는 독일의 수학자는 $3$차 곡면이 가질 수 있는 모양에 대해 연구하였습니다. 그는 케일리 삼차식으로부터의 변형을 이용하여 이 질문에 대한 답을 내놓았습니다. 이중 원뿔의 특이점을 확장, 절단 혹은 합치면서 $3$차 곡면이 가질 수 있는 모든 모양을 찾아냈습니다. 다음은 그 중 몇 가지 입니다. 
    \vspace{0.3cm}
     \begin{center}
      \vspace{-0.2cm}
